...
def main():
    ...
    ax.plot(t_plot.flatten(), S_pinn, color='#d62728', ls='-.', lw=2.5, label='PINN — Cu')
    ...
    plt.tight_layout()
    plt.savefig("melt_depth_Cu_PINN.png", dpi=150)
    print("  Figure saved: melt_depth_Cu_PINN.png")
    plt.show()
