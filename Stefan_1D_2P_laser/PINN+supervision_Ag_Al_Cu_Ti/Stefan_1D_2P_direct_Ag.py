...
# PINN + analytical supervision — Silver
# I = 1e9 W/m²,  t in [t_melt=1.15 s, 10 s]
# ============================================================
...
def main():
    ...
    ax.plot(t_plot.flatten(), S_pinn, color='#9467bd', ls=':', lw=2.5, label='PINN — Ag')
    ...
    plt.tight_layout()
    plt.savefig("melt_depth_Ag_PINN.png", dpi=150)
    print("  Figure saved: melt_depth_Ag_PINN.png")
    plt.show()
