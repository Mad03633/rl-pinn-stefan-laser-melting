# ============================================================
# Stefan_1D_2P_direct_Al.py  — v4
# PINN + analytical supervision — Aluminium
# I = 1e9 W/m²,  t in [t_melt=0.034 s, 10 s]
# ============================================================
...
def main():
    ...
    ax.plot(t_plot.flatten(), S_pinn, color='#1f77b4', ls='--', lw=2.5, label='PINN — Al')
    ...
    plt.tight_layout()
    plt.savefig("melt_depth_Al_PINN.png", dpi=150)
    print("  Figure saved: melt_depth_Al_PINN.png")
    plt.show()
