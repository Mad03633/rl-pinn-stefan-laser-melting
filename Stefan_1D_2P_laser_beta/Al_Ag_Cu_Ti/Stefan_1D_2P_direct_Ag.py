# ============================================================
# Stefan_1D_2P_direct_Ag.py  — v5 full
# PINN pure physics — Ag
# I = 1e9 W/m²,  t in [t_melt=1.15, 10 s]
# ============================================================
...
ks      = 429
kl      = 361
alpha_s = 1.738602e-04
alpha_l = 1.329356e-04
Tm      = 1234
T0      = 300.0
Lh      = 1.112e+05
A_s     = 0.02
...
def main():
    print("=" * 60)
    print("  PINN pure physics — Ag  [full training]")
    ...
    ax.plot(np.append(t_pre, t_melt_plot),
            ...
            color='#9467bd', ls=':', lw=2.5, label='PINN — Ag')
    ...
    ax2.axhline(Tm, color='gray', ls=':', lw=1.0, label=f'Tm = 1234 K')
    ax2.set_xlabel("z (cm)", fontsize=12)
    ax2.set_ylabel("Temperature (K)", fontsize=12)
    ax2.set_title(f"T(z) at t = {t_max} s", fontsize=11)
    ax2.legend(fontsize=10); ax2.grid(True, alpha=0.3)

    plt.suptitle(f"Ag  |  I = {I_laser:.0e} W/m²  |  {elapsed/60:.1f} min",
                 fontsize=12, y=1.01)
    plt.tight_layout()
    plt.savefig("melt_depth_Ag_PINN_full.png", dpi=150, bbox_inches='tight')
    print("  Saved: melt_depth_Ag_PINN_full.png")
    plt.show()
